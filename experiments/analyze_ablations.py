...
for ablation in ALL_ABLATIONS:
    ...
    bach_grades = bach_df['grade']
    print(np.round(np.mean(bach_grades), 3))
    print(np.round(np.std(bach_grades),2))
    mock_grades = mock_df['grade']
    print(np.round(np.mean(mock_grades), 3))
    print(np.round(np.std(mock_grades),2))
