...
# GRADES_CSV = 'tmp.csv'
BACH_GRADES_CSV = 'sum_bach_grades.csv'
MOCK_GRADES_CSV = 'sum_mock_grades.csv'
...
for ablation in ALL_ABLATIONS:
    ...
    lowest_mock = np.min(mock_grades)
    print(np.sum([1 for a,b in zip(bach_grades, mock_grades) if a<b]))
